...
String web_pages::getProfilePage(const AppState& state, const String& statusMessage) {
  ...
  const String modeOptions =
    ...
    const web_storage::TemplateToken tokens[] = {
      ...
      {"{{TEMPERATURE_SECTION}}", buildTemperatureSectionHtml(state)},
    };
